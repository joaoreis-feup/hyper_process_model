...
![Hyper-Model Comparison with Hyper-Process Model using a simple example of Beta Distribution](https://github.com/joaoreis-feup/hyper_process_model/blob/master/hm_hpm_results.PNG)
